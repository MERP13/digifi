...
fcl.config()
  .put("accessNode.api", "https://orbital-weathered-bird.flow-testnet.discover.quiknode.pro/1a2f4667cc1f810a9f7dc442f44321aa4a1b80a2")
  .put("sdk.transport", httpSend);

// Configure o fcl aqui antes de usar qualquer funcionalidade relacionada ao fcl.
fcl.config({
  // Para a Mainnet
...
fcl.config()
  ...
  fcl.config()
  .put("app.detail.title", "WePay")
  //.put("app.detail.icon", "URL do Ícone do Seu Aplicativo");
